...
void DivergenceDemo::load_parameters(const Parameters &params)
{
	try
	{
...
void DivergenceDemo::init_parameters(Parameters &params)
{
	params_ = &params;
}

void DivergenceDemo::compile_program(OpenCLBasic *oclobjects)
{
...
void DivergenceDemo::init_program_args(const float *input, int width,
...
void DivergenceDemo::deinit_program_args()
{
	free(h_out);
...
void DivergenceDemo::deinit_parameters()
{
	delete oprogram_;
	//params_->clear();
}
DivergenceDemo::~DivergenceDemo()
{
	deinit_parameters();
}
